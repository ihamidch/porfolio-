    ...
    >
      <motion.div {...fadeUp}>
        <SectionHeading
          ...
          description="Three featured MERN projects with a consistent SaaS card layout, clear feature highlights, and direct live/repository actions."
        />
      </motion.div>

      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-3">
        <MediumFeaturedCard
          label={mainFeaturedProject.label}
          title={mainFeaturedProject.title}
          subtitle={mainFeaturedProject.subtitle}
          description={mainFeaturedProject.description}
          keyFeatures={mainFeaturedProject.keyFeatures}
          techStack={mainFeaturedProject.techStack}
          liveUrl={mainFeaturedProject.liveUrl}
          repoUrl={mainFeaturedProject.repoUrl}
          tint="cyan"
        />
        <MediumFeaturedCard
