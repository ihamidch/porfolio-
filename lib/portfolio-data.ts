...
export const talentscoutProject: ProjectShowcase = {
  ...
  label: "AI SaaS · TalentScout (FastAPI + MERN)",
  summary:
    "AI-assisted recruitment platform with candidate screening workflows, recruiter dashboard, and separated web/API deployment.",
  liveUrl: env(
...
export const devOpsShowcases: DevOpsShowcase[] = [
...

  {
    ...
    label: "Vercel · Express + FastAPI",
    summary:
      "TalentScout backend surface (Node API with optional FastAPI AI engine) deployed separately for scalable AI-assisted screening workflows.",
    liveUrl: env(
      "NEXT_PUBLIC_LIVE_TALENTSCOUT_API",
      "https://talentscout-ai-api.vercel.app",
    ),
